...
function gh_appointment_model(callback) {
    // 移除已存在的模态框(防止重复添加)
    $('#confirm-modal').remove();
    let modalHTML =
        '<div class="modal" id="confirm-modal">' +
        ...
        '<span class="small-text default-text">'+'预约患者'+'</span>'+
        '<input class="input-rm-bg default-text" type="text" id="appointment_insurance">'+
